...
import com.transport.transport_service.entity.Location;
...
public interface LocationRepository extends JpaRepository<Location, Long> {
    ...
    @Query("SELECT l FROM Location l WHERE l.country = :country AND l.region = :region")
    List<Location> findByCountryAndRegion(@Param("country") String country, @Param("region") String region);
}
